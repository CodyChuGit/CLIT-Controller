...
function Item({
  ...
  return (
    <button
      onClick={onClick}
      title={title}
      className="focusable flex cursor-pointer items-center gap-1 rounded px-1.5 py-0.5 transition-colors duration-150 hover:bg-neutral-100 dark:hover:bg-neutral-800"
    >
      {children}
    </button>
  );
